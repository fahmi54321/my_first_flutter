...
class CAxisAlignment extends StatelessWidget {
  const CAxisAlignment({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
            color: Colors.blue,
            margin: EdgeInsets.only(left: 30.0, top: 0, right: 30.0),
            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Image(
                      image: AssetImage('assets/gambar/ktp.jpeg'),
                      height: 200,
                    ),
                    Text(
                      "Title",
